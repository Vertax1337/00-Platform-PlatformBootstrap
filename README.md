...
Der Bootstrap erstellt diese Repositories vollständig leer: kein README, kein `.gitignore`, kein `azure-pipelines.yml`, kein Initial-Commit und kein Scaffold.

## Kundenprojekt mit Firewalls
...
10-Automation/OPNsenseDocumentation = Sanitizer + Validator + Parser/Normalizer
...
`PlatformBootstrap` ist die Source of Truth für Aufbau und Weiterentwicklung der Azure-DevOps-Plattform. Bei bestehenden v1.4.x-Umgebungen wird nur das fehlende Repo ergänzt; vorhandene Repositories und Inhalte bleiben unverändert.
